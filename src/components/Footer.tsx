...
export default function Footer() {
  return (
    <>
      <footer className="w-full min-h-[250px] bg-[#04585d] flex flex-col items-center">
        ...
        <div className="w-full border-t-[1px] border-white text-center text-white font-bold  py-[20px]  px-[30px] box-border lg:w-[1080px]">
