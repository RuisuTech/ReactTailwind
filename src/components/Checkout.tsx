  ...
  return (
    <section
      className="w-[300px] p-[10px] m-[10px] flex flex-col 
                        sm:w-[340px]"
    >
      <div className="bg-[#04585d] p-[20px]  sm:p-[33px] rounded-[10px]">
        <span className="text-[#c0feff]">Total:</span>
        <h2 id="price" className="text-[28px] font-bold mt-[10px] text-white">
          $ {(product.price * quantity).toLocaleString()}
        </h2>
        <p className="leading-[20.4px] break-words text-white">
          Includes Country tax and AFIP collection
        </p>
        <ul className="p-0 list-none mb-[30px] text-white">
            ...
            <button
              ...
              className={
                button
                  ...
                  : "w-full bg-[#008c91] text-white font-bold border-none h-[40px] rounded-[10px] hover:bg-[#00b2b7] "
              }
              onClick={manageCart}
            >
